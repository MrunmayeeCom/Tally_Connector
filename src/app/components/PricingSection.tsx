...
// hardcoded pricing page as per 1500/per/user yearly 
            ...
            {PLANS.map((plan, index) => (
              ...
              >
                ...
                <div
                  className="pr-plan-chip"
                  style={{
                    background: `linear-gradient(135deg, ${plan.accentHex}cc, ${plan.accentHex})`,
                  }}
                >
                  <plan.icon size={12} />
                  {plan.name}
                ...
                <div className="pr-price-row">
                  ...
                  {!plan.isFree && (
                    <span className="pr-price-period">{plan.billingLabel}</span>
                  )}
                </div>

                {plan.savingsLabel ? (
                  <div className="pr-savings-badge">{plan.savingsLabel}</div>
                ) : (
