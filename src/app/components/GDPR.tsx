...
export default function GDPRCompliance() {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #1e2a4a 0%, #2d2870 50%, #9d2060 100%)",
    ...
    >
      ...
      >
        ...
        <div className="gdpr-card">
          <p>
            Tally Connect is committed to protecting the privacy and security of
            user data. Our platform follows industry best practices to ensure
            that all information processed through Tally Connect is handled
        ...
        <div className="gdpr-card">
          <p>
            When users connect their Tally Prime data through the Tally Connect
            Agent, the platform ensures that financial and accounting
            information is transmitted and processed with appropriate
            safeguards.
          </p>
        </div>
        ...
        <div className="gdpr-card" style={{ marginTop: 32 }}>
          ...
          <p>
            Tally Connect continuously works to maintain high standards of data
            protection and privacy to ensure that business financial information
